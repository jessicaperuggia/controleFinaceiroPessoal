...
export default function ModalTransaction({ isOpen, selectedTransaction = null, onClose, onSave, }) {
                ...
                <form onSubmit={handleFormSubmit}>
                    <div style={formStyle}>
                        ...
                        <div className='input-field'>
                            <input id='inputDescription' type='text' value={description} onChange={handleDescriptionChange} autoFocus required />
                            <label htmlFor='inputDescription' className='active'>Descrição:</label>
                        </div>

                        <div className='input-field'>
                            <input id='inputCategory' type='text' value={category} onChange={handleCategoryChange} required />
